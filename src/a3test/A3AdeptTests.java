...
public class A3AdeptTests {
	...
	public void testGradientPicture() {
		...
		System.out.println("red: " + g1.getRed() + " blue: " + g1.getBlue() + " green: " + g1.getGreen());
		System.out.println("red: " + gradient.getPixel(2, 1).getRed() + " blue: " + gradient.getPixel(2, 1).getBlue() + " green: " + gradient.getPixel(2, 1).getGreen());
